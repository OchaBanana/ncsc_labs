...
#. Open a web browser to your CVM IP: `http://<CVM IP:8000>` **USE YOUR ASSIGNED CVM IP**
...
#. On 4. AOS we will keep the default factory imaged software “we will skip AOS installation” and hit “Next”
#. On 5. Hypervisor same as previous step we will skip reimaging and hit “Next”
#. On 6. IPMI only on baremetal installation you would you need this step. When using the factory image we can skip this and hit “Start”
...
#. When completed. Open a web browser to C IP: `http://<Cluster_IP>` . Use admin with the Prism UI password “Nutanix/4u” provided in the lab. (You may change the password to one you’d like to use)
